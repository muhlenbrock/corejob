...
class _View_MyApp0 extends import1.AppView<import0.MyApp> {
  ...
  _Nav_21_4:import21.Wrapper_Nav;
  /*private*/ _expr_1:any;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Header_2_3 = new import16.Wrapper_Header(this.parentInjector.get(import24.Config),new import23.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import28.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import16.Wrapper_Toolbar(this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import24.Config),new import23.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import17.Wrapper_ToolbarTitle(this.parentInjector.get(import24.Config),new import23.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4.context,this.parentInjector.get(import29.Navbar,(null as any)));
    ...
    this._Content_11_4 = new import18.Wrapper_Content(this.parentInjector.get(import24.Config),new import23.ElementRef(this._el_11),this.renderer,this.parentInjector.get(import30.App),this.parentInjector.get(import25.Keyboard),this.parentInjector.get(import26.NgZone),this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import31.Tabs,(null as any)));
    ...
    var compView_21:any = import21.viewFactory_Nav0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Nav_21_4 = new import21.Wrapper_Nav(this.parentInjector.get(import28.ViewController,(null as any)),this.parentInjector.get(import34.NavControllerBase,(null as any)),this.parentInjector.get(import30.App),this.parentInjector.get(import24.Config),this.parentInjector.get(import25.Keyboard),new import23.ElementRef(this._el_21),this.parentInjector.get(import26.NgZone),this.renderer,this.parentInjector.get(import35.ComponentFactoryResolver),this.parentInjector.get(import27.GestureController),this.parentInjector.get(import36.TransitionController),this.parentInjector.get(import37.DeepLinker,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import38.ToolbarTitle) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._ToolbarTitle_6_4.context; }
    if (((token === import39.Toolbar) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._Toolbar_4_4.context; }
    if (((token === import39.Header) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 9)))) { return this._Header_2_3.context; }
    if (((token === import32.TemplateRef) && (15 === requestNodeIndex))) { return this._TemplateRef_15_5; }
    if (((token === import40.NgFor) && (15 === requestNodeIndex))) { return this._NgFor_15_6.context; }
    if (((token === import41.List) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._List_13_3.context; }
    if (((token === import42.Content) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_11_4.context; }
    if (((token === import43.Menu) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Menu_0_4.context; }
    if (((token === import44.Nav) && (21 === requestNodeIndex))) { return this._Nav_21_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  _MenuClose_0_6:import46.Wrapper_MenuClose;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Item_0_4 = new import45.Wrapper_Item(this.parent.parentInjector.get(import47.Form),this.parent.parentInjector.get(import24.Config),new import23.ElementRef(this._el_0),this.renderer,this.parent.parentInjector.get(import48.ItemReorder,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import49.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_4.context; }
    if (((token === import49.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5.context; }
    if (((token === import50.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._MenuClose_0_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
