...
import * as import45 from '../node_modules/ionic-angular/components/menu/menu-close.ngfactory';
...
import * as import49 from 'ionic-angular/components/menu/menu-close';
...
class _View_MyApp_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._MyApp_0_4 = new Wrapper_MyApp(this.parentInjector.get(import8.Platform),this.parentInjector.get(import9.AlertController),this.parentInjector.get(import10.Http));
...
class _View_MyApp0 extends import1.AppView<import0.MyApp> {
  ...
  _Nav_21_4:import20.Wrapper_Nav;
  /*private*/ _expr_1:any;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Menu_0_4 = new import14.Wrapper_Menu(this.parentInjector.get(import21.MenuController),new import22.ElementRef(this._el_0),this.parentInjector.get(import23.Config),this.parentInjector.get(import8.Platform),this.renderer,this.parentInjector.get(import24.Keyboard),this.parentInjector.get(import25.NgZone),this.parentInjector.get(import26.GestureController));
    ...
    this._Header_2_3 = new import15.Wrapper_Header(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import27.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import15.Wrapper_Toolbar(this.parentInjector.get(import27.ViewController,(null as any)),this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import16.Wrapper_ToolbarTitle(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4.context,this.parentInjector.get(import28.Navbar,(null as any)));
    ...
    this._List_13_3 = new import18.Wrapper_List(this.parentInjector.get(import23.Config),new import22.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import26.GestureController));
    ...
    this._NgFor_15_6 = new import19.Wrapper_NgFor(this._appEl_15.vcRef,this._TemplateRef_15_5,this.parentInjector.get(import32.IterableDiffers),this.ref);
    ...
    var compView_21:any = import20.viewFactory_Nav0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Nav_21_4 = new import20.Wrapper_Nav(this.parentInjector.get(import27.ViewController,(null as any)),this.parentInjector.get(import33.NavControllerBase,(null as any)),this.parentInjector.get(import29.App),this.parentInjector.get(import23.Config),this.parentInjector.get(import24.Keyboard),new import22.ElementRef(this._el_21),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import34.ComponentFactoryResolver),this.parentInjector.get(import26.GestureController),this.parentInjector.get(import35.TransitionController),this.parentInjector.get(import36.DeepLinker,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import43.Nav) && (21 === requestNodeIndex))) { return this._Nav_21_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  _MenuClose_0_6:import45.Wrapper_MenuClose;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Item_0_4 = new import44.Wrapper_Item(this.parent.parentInjector.get(import46.Form),this.parent.parentInjector.get(import23.Config),new import22.ElementRef(this._el_0),this.renderer,this.parent.parentInjector.get(import47.ItemReorder,(null as any)));
    this._ItemContent_0_5 = new import44.Wrapper_ItemContent();
    this._MenuClose_0_6 = new import45.Wrapper_MenuClose(this.parent.parentInjector.get(import21.MenuController));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import48.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_4.context; }
    if (((token === import48.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5.context; }
    if (((token === import49.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._MenuClose_0_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
