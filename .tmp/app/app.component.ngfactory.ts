...
class _View_MyApp0 extends import1.AppView<import0.MyApp> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Header_2_3 = new import14.Wrapper_Header(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import26.ViewController,(null as any)));
    ...
    this._Toolbar_4_4 = new import14.Wrapper_Toolbar(this.parentInjector.get(import26.ViewController,(null as any)),this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_4),this.renderer);
    ...
    this._ToolbarTitle_6_4 = new import15.Wrapper_ToolbarTitle(this.parentInjector.get(import22.Config),new import21.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4.context,this.parentInjector.get(import27.Navbar,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import42.Nav) && (21 === requestNodeIndex))) { return this._Nav_21_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
