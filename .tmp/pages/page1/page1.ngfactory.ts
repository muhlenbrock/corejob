...
class _View_Page10 extends import1.AppView<import0.Page1> {
  ...
  _Content_4_4:import13.Wrapper_Content;
  _text_5:any;
  _el_6:any;
  _List_6_3:import14.Wrapper_List;
  _text_7:any;
  _el_8:any;
  /*private*/ _appEl_8:import3.AppElement;
  _Item_8_4:import15.Wrapper_Item;
  _ItemContent_8_5:import15.Wrapper_ItemContent;
  _query_Label_8_0:import16.QueryList<any>;
  _query_Button_8_1:import16.QueryList<any>;
  _query_Icon_8_2:import16.QueryList<any>;
  _text_9:any;
  _el_10:any;
  /*private*/ _appEl_10:import3.AppElement;
  _NgModel_10_4:import17.Wrapper_NgModel;
  _NgControl_10_5:any;
  _NgControlStatus_10_6:import18.Wrapper_NgControlStatus;
  _TextInput_10_7:import19.Wrapper_TextInput;
  _text_11:any;
  _text_12:any;
  _el_13:any;
  ...
  _NgModel_15_4:import17.Wrapper_NgModel;
  _NgControl_15_5:any;
  _NgControlStatus_15_6:import18.Wrapper_NgControlStatus;
  _TextInput_15_7:import19.Wrapper_TextInput;
  _text_16:any;
  _text_17:any;
  _text_18:any;
  _el_19:any;
  /*private*/ _appEl_19:import3.AppElement;
  _Button_19_4:import20.Wrapper_Button;
  _text_20:any;
  _text_21:any;
  _el_22:any;
  /*private*/ _appEl_22:import3.AppElement;
  _Button_22_4:import20.Wrapper_Button;
  _text_23:any;
  _text_24:any;
  _el_25:any;
  _text_26:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    var compView_4:any = import13.viewFactory_Content0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Content_4_4 = new import13.Wrapper_Content(this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import24.App),this.parentInjector.get(import25.Keyboard),this.parentInjector.get(import26.NgZone),this.parentInjector.get(import23.ViewController,(null as any)),this.parentInjector.get(import27.Tabs,(null as any)));
    ...
    var compView_8:any = import15.viewFactory_Item0(this.viewUtils,this.injector(8),this._appEl_8);
    this._Item_8_4 = new import15.Wrapper_Item(this.parentInjector.get(import29.Form),this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_8),this.renderer,this.parentInjector.get(import30.ItemReorder,(null as any)));
    this._ItemContent_8_5 = new import15.Wrapper_ItemContent();
    this._query_Label_8_0 = new import16.QueryList<any>();
    this._query_Button_8_1 = new import16.QueryList<any>();
    this._query_Icon_8_2 = new import16.QueryList<any>();
    ...
    var compView_10:any = import19.viewFactory_TextInput0(this.viewUtils,this.injector(10),this._appEl_10);
    this._NgModel_10_4 = new import17.Wrapper_NgModel((null as any),(null as any),(null as any),(null as any));
    ...
    this._TextInput_10_7 = new import19.Wrapper_TextInput(this.parentInjector.get(import21.Config),this.parentInjector.get(import29.Form),this._Item_8_4.context,this.parentInjector.get(import24.App),this.parentInjector.get(import31.Platform),new import22.ElementRef(this._el_10),this.renderer,this._Content_4_4.context,this.parentInjector.get(import8.NavController,(null as any)),this._NgControl_10_5);
    ...
    this._Item_13_4 = new import15.Wrapper_Item(this.parentInjector.get(import29.Form),this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import30.ItemReorder,(null as any)));
    ...
    var compView_15:any = import19.viewFactory_TextInput0(this.viewUtils,this.injector(15),this._appEl_15);
    this._NgModel_15_4 = new import17.Wrapper_NgModel((null as any),(null as any),(null as any),(null as any));
    ...
    this._TextInput_15_7 = new import19.Wrapper_TextInput(this.parentInjector.get(import21.Config),this.parentInjector.get(import29.Form),this._Item_13_4.context,this.parentInjector.get(import24.App),this.parentInjector.get(import31.Platform),new import22.ElementRef(this._el_15),this.renderer,this._Content_4_4.context,this.parentInjector.get(import8.NavController,(null as any)),this._NgControl_15_5);
    ...
    var compView_19:any = import20.viewFactory_Button0(this.viewUtils,this.injector(19),this._appEl_19);
    this._Button_19_4 = new import20.Wrapper_Button((null as any),'',this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_19),this.renderer);
    ...
    var compView_22:any = import20.viewFactory_Button0(this.viewUtils,this.injector(22),this._appEl_22);
    this._Button_22_4 = new import20.Wrapper_Button((null as any),'',this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_22),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import32.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 2)))) { return this._Header_0_3.context; }
    if (((token === import33.NgModel) && (10 === requestNodeIndex))) { return this._NgModel_10_4.context; }
    if (((token === import34.NgControl) && (10 === requestNodeIndex))) { return this._NgControl_10_5; }
    if (((token === import35.NgControlStatus) && (10 === requestNodeIndex))) { return this._NgControlStatus_10_6.context; }
    if (((token === import36.TextInput) && (10 === requestNodeIndex))) { return this._TextInput_10_7.context; }
    if (((token === import37.Item) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Item_8_4.context; }
    if (((token === import37.ItemContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._ItemContent_8_5.context; }
    if (((token === import33.NgModel) && (15 === requestNodeIndex))) { return this._NgModel_15_4.context; }
    if (((token === import34.NgControl) && (15 === requestNodeIndex))) { return this._NgControl_15_5; }
    if (((token === import35.NgControlStatus) && (15 === requestNodeIndex))) { return this._NgControlStatus_15_6.context; }
    if (((token === import36.TextInput) && (15 === requestNodeIndex))) { return this._TextInput_15_7.context; }
    if (((token === import37.Item) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Item_13_4.context; }
    if (((token === import37.ItemContent) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._ItemContent_13_5.context; }
    if (((token === import38.List) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._List_6_3.context; }
    if (((token === import39.Button) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._Button_19_4.context; }
    if (((token === import39.Button) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Button_22_4.context; }
    if (((token === import40.Content) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 26)))) { return this._Content_4_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
