...
function viewFactory_Page1_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_Page1_Host === (null as any))) { (renderType_Page1_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_Page1_Host0(viewUtils,parentInjector,declarationEl);
}
export const Page1NgFactory:import10.ComponentFactory<import0.Page1> = new import10.ComponentFactory<import0.Page1>('page-page1',viewFactory_Page1_Host0,import0.Page1);
...
class _View_Page10 extends import1.AppView<import0.Page1> {
  ...
  _Content_4_4:import12.Wrapper_Content;
  _text_5:any;
  _el_6:any;
  _List_6_3:import13.Wrapper_List;
  _text_7:any;
  _el_8:any;
  /*private*/ _appEl_8:import3.AppElement;
  _Item_8_4:import14.Wrapper_Item;
  _ItemContent_8_5:import14.Wrapper_ItemContent;
  _query_Label_8_0:import15.QueryList<any>;
  _query_Button_8_1:import15.QueryList<any>;
  _query_Icon_8_2:import15.QueryList<any>;
  _text_9:any;
  _el_10:any;
  /*private*/ _appEl_10:import3.AppElement;
  _TextInput_10_4:import16.Wrapper_TextInput;
  _text_11:any;
  _text_12:any;
  _el_13:any;
  /*private*/ _appEl_13:import3.AppElement;
  _Item_13_4:import14.Wrapper_Item;
  _ItemContent_13_5:import14.Wrapper_ItemContent;
  ...
  _TextInput_15_4:import16.Wrapper_TextInput;
  _text_16:any;
  _text_17:any;
  _text_18:any;
  _el_19:any;
  /*private*/ _appEl_19:import3.AppElement;
  _Button_19_4:import17.Wrapper_Button;
  _text_20:any;
  _text_21:any;
  _el_22:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    var compView_4:any = import12.viewFactory_Content0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Content_4_4 = new import12.Wrapper_Content(this.parentInjector.get(import18.Config),new import19.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import21.App),this.parentInjector.get(import22.Keyboard),this.parentInjector.get(import23.NgZone),this.parentInjector.get(import20.ViewController,(null as any)),this.parentInjector.get(import24.Tabs,(null as any)));
    ...
    var compView_8:any = import14.viewFactory_Item0(this.viewUtils,this.injector(8),this._appEl_8);
    this._Item_8_4 = new import14.Wrapper_Item(this.parentInjector.get(import26.Form),this.parentInjector.get(import18.Config),new import19.ElementRef(this._el_8),this.renderer,this.parentInjector.get(import27.ItemReorder,(null as any)));
    this._ItemContent_8_5 = new import14.Wrapper_ItemContent();
    this._query_Label_8_0 = new import15.QueryList<any>();
    this._query_Button_8_1 = new import15.QueryList<any>();
    this._query_Icon_8_2 = new import15.QueryList<any>();
    ...
    var compView_10:any = import16.viewFactory_TextInput0(this.viewUtils,this.injector(10),this._appEl_10);
    this._TextInput_10_4 = new import16.Wrapper_TextInput(this.parentInjector.get(import18.Config),this.parentInjector.get(import26.Form),this._Item_8_4.context,this.parentInjector.get(import21.App),this.parentInjector.get(import28.Platform),new import19.ElementRef(this._el_10),this.renderer,this._Content_4_4.context,this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import29.NgControl,(null as any)));
    this._appEl_10.initComponent(this._TextInput_10_4.context,([] as any[]),compView_10);
    compView_10.create(this._TextInput_10_4.context,([] as any[]),(null as any));
    ...
    var compView_13:any = import14.viewFactory_Item0(this.viewUtils,this.injector(13),this._appEl_13);
    this._Item_13_4 = new import14.Wrapper_Item(this.parentInjector.get(import26.Form),this.parentInjector.get(import18.Config),new import19.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import27.ItemReorder,(null as any)));
    ...
    var compView_15:any = import16.viewFactory_TextInput0(this.viewUtils,this.injector(15),this._appEl_15);
    this._TextInput_15_4 = new import16.Wrapper_TextInput(this.parentInjector.get(import18.Config),this.parentInjector.get(import26.Form),this._Item_13_4.context,this.parentInjector.get(import21.App),this.parentInjector.get(import28.Platform),new import19.ElementRef(this._el_15),this.renderer,this._Content_4_4.context,this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import29.NgControl,(null as any)));
    this._appEl_15.initComponent(this._TextInput_15_4.context,([] as any[]),compView_15);
    compView_15.create(this._TextInput_15_4.context,([] as any[]),(null as any));
    ...
    var compView_19:any = import17.viewFactory_Button0(this.viewUtils,this.injector(19),this._appEl_19);
    this._Button_19_4 = new import17.Wrapper_Button((null as any),'',this.parentInjector.get(import18.Config),new import19.ElementRef(this._el_19),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import30.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 2)))) { return this._Header_0_3.context; }
    if (((token === import31.TextInput) && (10 === requestNodeIndex))) { return this._TextInput_10_4.context; }
    if (((token === import32.Item) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Item_8_4.context; }
    if (((token === import32.ItemContent) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._ItemContent_8_5.context; }
    if (((token === import31.TextInput) && (15 === requestNodeIndex))) { return this._TextInput_15_4.context; }
    if (((token === import32.Item) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Item_13_4.context; }
    if (((token === import32.ItemContent) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._ItemContent_13_5.context; }
    if (((token === import33.List) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._List_6_3.context; }
    if (((token === import34.Button) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._Button_19_4.context; }
    if (((token === import34.Button) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Button_22_4.context; }
    if (((token === import35.Content) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 26)))) { return this._Content_4_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
